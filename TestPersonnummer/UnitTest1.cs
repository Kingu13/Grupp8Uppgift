...
{ 
    ...
    public void Main_ValidPersonnummer_ShouldPrintCorrectMessage(string personnummer)
    {
        ...
        string expectedMessage = "Personnumret är korrekt.";
        string actualOutput = consoleOutput.ToString();
        Assert.IsTrue(actualOutput.Contains(expectedMessage), $"Expected message not found in actual output. Expected: {expectedMessage}, Actual: {actualOutput}");
    }
